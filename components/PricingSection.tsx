...
const tiers = [
  {
    ...
    badge: null,
    icon: Zap,
    description: "For an individual creator or a small team with not more than $100k of revenue or funding in the last 12 months.",
    cta: "Get Cortex — Personal",
    ctaHref: "https://www.fab.com",
    features: [
      { text: "All 18 builders (Blueprints, Widgets, VFX, Audio…)", included: true },
      { text: "Niagara VFX, Level Sequencer, MetaSounds", included: true },
      { text: "AI Behavior Trees & Animation Blueprints", included: true },
      { text: "Pose Search & Motion Matching", included: true },
      { text: "PCG Biome Builder (8 presets)", included: true },
      { text: "Sound Cues, IK Rigs, Python Scripting", included: true },
      { text: "Chat, Optimizer, Analyst, Biome & Help modes", included: true },
      { text: "Claude, GPT, Custom endpoint support", included: true },
      { text: "Auto-retry on compile errors", included: true },
      { text: "Image / screenshot attach (vision)", included: true },
      ...
      { text: "Free updates for the major version", included: true },
    ],
  },
  {
    name: "Professional",
    ...
    badge: "Studios & Teams",
    icon: Crown,
    description: "For studios or other entities with over $100k revenue or funding in the past 12 months.",
    cta: "Get Cortex — Professional",
    ctaHref: "https://www.fab.com",
    features: [
